      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">Explore the Events</h1>
            <p className="text-xl text-gray-600">Embark on a journey of discovery as we explore a myraid of events, from cultural celebrations to thrilling adventures. Join us in creating unforgettable memories!</p>
          </div>
